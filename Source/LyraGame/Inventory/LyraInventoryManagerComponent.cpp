		...
		if (Entry.Instance != nullptr) //@TODO: Would prefer to not deal with this here and hide it further?
			{
				...
				{
					Entry.StackCount = Entry.StackCount + 1;
...
int32 ULyraInventoryManagerComponent::GetStackSize(ULyraInventoryItemInstance* ItemInstance)
{
	return InventoryList.GetStackSize(ItemInstance);
}

int32 FLyraInventoryList::GetStackSize(ULyraInventoryItemInstance* Instance)
{
	for (auto EntryIt = Entries.CreateIterator(); EntryIt; ++EntryIt)
	{
		FLyraInventoryEntry& Entry = *EntryIt;
