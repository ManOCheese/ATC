...
public class ATCTarget : TargetRules
{
	public ATCTarget(TargetInfo Target) : base(Target)
	{
		...
		ATCTarget.ApplySharedLyraTargetSettings(this);
	}
	...
	internal static void ApplySharedLyraTargetSettings(TargetRules Target)
    {
		...
		if (Target.BuildEnvironment == TargetBuildEnvironment.Unique)
		{
			...
			ATCTarget.ConfigureGameFeaturePlugins(Target);
		}
		else
        {
			// !!!!!!!!!!!! WARNING !!!!!!!!!!!!!
